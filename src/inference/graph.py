...
def wrapperClassify():
    # 得到lvm方法分类模型对应的指标
    data = [[97.40068661108387, 98.43060323688081, 95.11278195488721, 97.40068661108387, 88.45246893011378],
            [98.52869053457577, 99.41147621383031, 97.36842105263158, 98.52869053457577, 89.53380599370298],
